...
interface PRPSAAssessmentProps {
  speechId: string;
  onComplete: (prpsa: any) => void;
  onCancel: () => void;
  existingResponses?: Record<string, number>;
  isUpdate?: boolean;
}

export default function PRPSAAssessment({ 
  speechId, 
  onComplete, 
  onCancel, 
  existingResponses = {}, 
  isUpdate = false 
}: PRPSAAssessmentProps) {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      // The API call will be handled by the parent component
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          ...
          <li>• Be honest - this assessment is for your benefit and speech improvement</li>
        </ul>
      </div>
    </div>
  );
